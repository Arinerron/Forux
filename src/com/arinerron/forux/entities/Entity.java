...
public class Entity {
    ...
    public JSONObject toJSON() {
        return new JSONObject().put("uuid", this.getUUID()).put("imagepath", this.getImagePath()).put("x", this.getX()).put("y", this.getY()).put("world", this.getWorld()).put("visible", this.isVisible());
    }
