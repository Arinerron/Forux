...
public class TextField extends Component {
    ...
    public void onDraw(Graphics g2) {
        ...
        BufferedImage image = new BufferedImage((int) (this.getWidth() + (stroke * 17.5)), this.getHeight() + (stroke * 2), BufferedImage.TYPE_INT_ARGB);
        ...
        g.drawString(ss, this.getX() + 5, -2 + (int) (this.getY() + ((double) (this.getHeight() / 2) + (double) (g.getFontMetrics().getHeight() / 2)))); // THIS FUNCTION DRAWS THE TEXT. YOU MAY HAVE TO CUSTOMIZE IT
    ...
    public void onMouseDown(int x, int y) {
        ...
        Rectangle coords = new Rectangle(this.getX(), this.getY(), this.getWidth(), this.getHeight());
    ...
    @Override
    public void onKeyPress(KeyEvent e) { // TODO: Add numbers-only support, etc....
        if (this.hasFocus() && this.isEnabled() && this.isEditable()) {
            ...
            if (this.isPrintableChar(e.getKeyChar()) && validString.indexOf(String.valueOf(e.getKeyChar()).toLowerCase()) != -1) {
                if (this.unchanged)
                    this.setText("");
